...
import io.boomerang.integrations.model.IntegrationStatus;
...
public class IntegrationService {
  ...
  public List<Integration> get(String team) {
    ...
    templates.forEach(t -> {
      ...
      List<String> refs = relationshipService.getFilteredRefs(Optional.of(RelationshipType.INTEGRATION),
  ...
  public String getTeamByRef(String ref) {
    ...
    if (optEntity.isPresent()) {
      ...
      String team = relationshipService.getTeamSlugFromChild(RelationshipType.INTEGRATION, optEntity.get().getId());
  ...
  public void delete(String type, JsonNode data) {
    ...
    if (optEntity.isPresent()) {
      ...
      relationshipService.removeNodeByRefOrSlug(RelationshipType.INTEGRATION, entity.getId());
    }
  }
}
